...
Even if you can do crazy stuff in Excel - i mean look at this gif that i found on reddit. In our opinion, Exceltables should be seen as a mere Endproduct. We prefer not doing anykind of datamanipulation or extensive formatting in Excel. TO ensure reproducibility and repeatability.  Thats why we've set up r-functions that allow for generating the final output without ever leaving R. 
...
# What have we achieved with our CD-Toolbox?

- drastic reduction of time spend with hands-on formatting
- set standards through convienience, not by 'force'
- reproducible outputs until the last step!
- gained experience that will help us setting up something similar for further channels and products (e.g. html-pages / shiny-apps)
...
statR-package (colors, theme and xlsx-templates)
https://statistikzh.github.io/statR/

statRmd-package (templates for pdf-reports)
